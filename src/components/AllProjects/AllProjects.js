...
import projectNew from "../../image/mr-travel.png";
          ...
          <div className="col-lg-12">
            <div className="row">
              <div className="col-lg-6 site2 ">
                ...
                <h3>Educal</h3>
                <div className="info2 ">
                  The main purpose of this website is to provide various online courses. From where
                  the user can choose the course of any category
                </div>
                <ul className="mt-4 tools">
                  <li>HTML</li>
                  <li>CSS</li>
          ...
          <div className="col-lg-12">
            <div className="row div">
              ...
              <div className="col-lg-6 site ">
                ...
                <h3>E-Ticket</h3>
                <div className="info ">
                  The main purpose of this website is to book tickets for various sports and events
                  online. From where the user sports, events in any category Can book tickets.
                </div>
                <ul className="mt-4 tools">
                  <li>React Js</li>
                  <li>Bootstrap CSS</li>
